...
### EXPLAIN ANALYZE
-> Filter: (orders.reference_code = 12345)  (cost=202.50 rows=200) (actual time=1.297..1.297 rows=0 loops=1)
    -> Table scan on orders  (cost=202.50 rows=2000) (actual time=0.023..0.611 rows=2000 loops=1)
