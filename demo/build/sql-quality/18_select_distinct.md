...
### EXPLAIN ANALYZE
-> Group (no aggregates)  (actual time=0.013..0.013 rows=0 loops=1)
    -> Filter: ((comments.user_id in (371,963)) and (comments.id in (1,2,555,999)))  (cost=1.86 rows=8) (actual time=0.013..0.013 rows=0 loops=1)
        -> Index range scan on comments using user_id  (cost=1.86 rows=8) (actual time=0.012..0.012 rows=0 loops=1)
