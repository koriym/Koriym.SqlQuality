...
### EXPLAIN Results
{"query_block":{"select_id":1,"cost_info":{"query_cost":"107.00"},"table":{"table_name":"u","access_type":"ALL","rows_examined_per_scan":1000,"rows_produced_per_join":100,"filtered":"10.00","cost_info":{"read_cost":"97.00","eval_cost":"10.00","prefix_cost":"107.00","data_read_per_join":"209K"},"used_columns":["id","name","email","status","created_at","updated_at"],"attached_condition":"(`test`.`u`.`status` = 'active')"},"select_list_subqueries":[{"dependent":true,"cacheable":false,"query_block":{"select_id":3,"cost_info":{"query_cost":"1.97"},"table":{"table_name":"comments","access_type":"ref","possible_keys":["user_id"],"key":"user_id","used_key_parts":["user_id"],"key_length":"5","ref":["test.u.id"],"rows_examined_per_scan":9,"rows_produced_per_join":9,"filtered":"100.00","using_index":true,"cost_info":{"read_cost":"1.01","eval_cost":"0.97","prefix_cost":"1.98","data_read_per_join":"309"},"used_columns":["user_id"]}}},{"dependent":true,"cacheable":false,"query_block":{"select_id":2,"cost_info":{"query_cost":"1.23"},"table":{"table_name":"orders","access_type":"ref","possible_keys":["idx_orders_user_id"],"key":"idx_orders_user_id","used_key_parts":["user_id"],"key_length":"5","ref":["test.u.id"],"rows_examined_per_scan":2,"rows_produced_per_join":2,"filtered":"100.00","using_index":true,"cost_info":{"read_cost":"1.00","eval_cost":"0.23","prefix_cost":"1.23","data_read_per_join":"704"},"used_columns":["user_id"]}}}]}}
